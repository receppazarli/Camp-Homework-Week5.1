...
public interface SubTechnologiesService {
	...
	void add(CreateSubTechnologiesRequest createSubTechnologiesRequest) throws Exception;

	void update(UpdateSubTechnologiesRequest updateSubTechnologiesRequest) throws Exception;

	void delete(DeleteSubTechnologiesRequest deleteSubTechnologiesRequest) throws Exception;
