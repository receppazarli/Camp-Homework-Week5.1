...
public class SubTechnologiesManager implements SubTechnologiesService {
	...
	public void update(UpdateSubTechnologiesRequest updateSubTechnologiesRequest) throws Exception {
		...
		SubTechnologies subTechnologies = this.subTechnologiesRepository.findById(updateSubTechnologiesRequest.getId()).get();
		
		Language language = this.languageRepository.findById(updateSubTechnologiesRequest.getLanguageId()).get();

		subTechnologies.setName(updateSubTechnologiesRequest.getName());
		subTechnologies.setLanguage(language);
		this.subTechnologiesRepository.save(subTechnologies);
	}
	...
	public void delete(DeleteSubTechnologiesRequest deleteSubTechnologiesRequest) throws Exception {
		if (!isIdExist(deleteSubTechnologiesRequest.getId())) {
			throw new Exception("Id not found");
		}
		this.subTechnologiesRepository.deleteById(deleteSubTechnologiesRequest.getId());
